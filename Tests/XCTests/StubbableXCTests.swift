...
final class StubbableXCTests: XCTestCase {
    ...
    func test_on_a_class() {
        ...
        XCTAssertThrowsAssertion(expression: StubbableTestHelper.classFunction())
    ...
    func test_class_version_spot_check() {
        ...
        XCTAssertThrowsAssertion(expression: StubbableTestHelper.stub(.classFunction).andReturn("original return value"))
...
private extension StubbableXCTests {
