...
public extension String {
    ...
    func spryDiffed(with other: String) -> String {
        return .spry.diff(self, other)
    }
}

public extension Spry {
    static func diff(_ first: String, _ second: String) -> String {
        return .spry.diff(first, second)
    }
}
