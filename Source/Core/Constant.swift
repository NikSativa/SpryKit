...
internal enum Constant {
    enum FatalError {
        ...
        static func noReturnValueFoundForInstanceFunction<S: Stubbable, R>(stubbable: S, function: S.Function, arguments: [Any?], returnType _: R.Type) -> Never {
        ...
        static func noReturnValueFoundForClassFunction<S: Stubbable, R>(stubbableType _: S.Type, function: S.ClassFunction, arguments: [Any?], returnType _: R.Type) -> Never {
        ...
        static func andThrowOnNonThrowingClassFunction<S: Stubbable>(stubbable _: S.Type, function: S.ClassFunction) -> Never {
            andThrowOnNonThrowingFunction(type: S.self, functionName: function.rawValue)
        }
